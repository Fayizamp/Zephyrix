...
const WhatsappFloat: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-[1000] bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg w-14 h-14 flex items-center justify-center transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-400"
